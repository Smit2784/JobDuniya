        ...
        <>
            <NavbarBeforeLogin
                leftSection={
                    <FormButton
                        text={"Sign Up"}
                        className="px-4 py-2 bg-[#23A6F0] text-white rounded-lg hover:bg-[#1a8cd8] transition-colors"
                ...
                <div class="containerTermPage">
                    ...
                    <div className="mainTermPage">
                        <p class="pTermPage">
                            ...
                            future amendments (hereinafter collectively referred
                            to as the <strong>“Terms &amp; Conditions”</strong>)
                            before using the Job Portal / website
                            www.freshtechjobs.com (hereinafter referred to as{" "}
                            <strong>“Job Portal”</strong>). By using the Job
                            Portal, the Users are giving their consent to be
                            bound by the stipulations as contained under the
                        ...
                        <p class="pTermPage">
                            ...
                            Technical Degrees and Companies who recruit
                            technical freshers.
                        </p>
                        <h2>
                        ...
                        <p class="pTermPage">
                            ...
                            The contents of the Job Portal and of all other
                            websites, whether partial or otherwise such as text,
                            graphics, images, logos, button icons, software and
                            other contents as well as compilation of contents
                            (i.e. the collection, arrangement and assembly), are
                            property of the job portal . Unauthorized use of
                            such Content will be violation of copyright and
                            other intellectual property rights of the job
                            portal. The User may not sell or modify the said
                            content or reproduce, display, publicly perform,
                            distribute, or otherwise use such content in any way
                            for any public or commercial purpose. The use of the
                            job portal’s content on any other web site or in a
                        ...
                        <p class="pTermPage">
                            ...
                            solely responsible for all activities happening
                            under his/her username whether authorized or not.
                        ...
                        <p class="pTermPage">
                            ...
                            any or all entries/blogs at their absolute
                            discretion without giving any prior notice and
                        ...
                        <p class="pTermPage">
                            ...
                            arising therefrom. The User agrees that he shall use
                            the Job Portal in accordance with all laws, rules
                            and regulations, as applicable from time to time,
                            including, without limitation, the Information
                            Technology law and laws relating to unfair
                            competition, anti discrimination, false advertising
                            and defamation. The User further agrees that the
                            usage of Job Portal by the User shall not violate
                            any third party rights including but not limited to
                            Intellectual Property Rights, Right of Privacy and
                            Right of Publicity. In addition to above, the User
                            agrees that he shall not use the Job Portal in order
                            to transmit, distribute, store or destroy material,
                            that is defamatory, obscene, threatening, abusive or
                            hateful including, without limitation, the job
                            portal’s content. Any violation of any of the
                            foregoing, including the terms and conditions
                            mentioned herein shall result in the immediate
                        ...
                        <p class="pTermPage">
                            ...
                            <strong>
                                without limitation the following activities: (a)
                            </strong>{" "}
                            accessing data not intended for such User or logging
                            into a server or account which the User is not
                            authorized to access; <strong>(b)</strong>{" "}
                            ...
                            authorization; <strong>(c)</strong> attempting to
                            interfere with service to any User, host or network,
                            including, without limitation, via means of
                            submitting a virus to Job Portal, overloading,{" "}
                            <strong>“flooding”</strong> ,{" "}
                            <strong>“spamming”</strong> ,{" "}
                            <strong>“mailbombing”</strong> or{" "}
                            <strong>“crashing”</strong> ; or{" "}
                            <strong>(d)</strong> forging any TCP/IP packet
                            header or any part of the header information in any
                            e-mail or newsgroup posting. Violations of system or
                            network security shall result in civil or criminal
                            liability. The Company will investigate occurrences,
                            which may involve such violations and shall inform
                            and co-operate with, law enforcement authorities in
                        ...
                        <p class="pTermPage">
                            ...
                            Though the job portal reserves the right to filter
                            out postings which may carry offensive, harmful,
                            inaccurate, pornographic content or content which
                            infringes on the Intellectual Property Rights of any
                            third party or any rights of publicity or privacy or
                            is defamatory, libelous, threatening or harassing or
                            is indecent and contains any viruses, trojan horses,
                            trap doors, back doors, easter eggs, worms, time
                            ...
                            or otherwise inappropriate content, it does not take
                            any responsibility for such content and/or for
                            deceptive, mislabeled or defamatory content. The job
                            portal merely provides a platform to access the
                            content posted by the Users by using the Services of
                            the Job portal. The Users are expected to take
                            necessary precautions and comply with various
                        ...
                        <p class="pTermPage">
                            ...
                            following. The list below is for illustration only
                            ...
                            <ol>
                                ...
                                <p class="pTermPage">
                                    ...
                                    threatening, obscene, defamatory, libelous
                                ...
                                <p class="pTermPage">
                                    ...
                                    making available pirated computer programs
                                    or links to them, providing or making
                                    available information to circumvent
                                    manufacturer-installed copy-protect devices,
                                    or providing or making available pirated
                                ...
                                <p class="pTermPage">
                                    ...
                                    including, without limitation, making or
                                    buying illegal weapons, violating someone’s
                                    privacy, or provides or creates computer
                                    viruses or pirating any media; and solicits
