...
const LoginAsCompany = ({ setScreen }) => {
    ...
    const leftSection = (
        <div className="flex flex-col items-start justify-center h-full pl-10 text-white">
            <span>looking to Jobs ? </span>
            <span
                className="text-4xl font-bold cursor-pointer hover:text-blue-200 transition"
                onClick={() => navigate("/loginasuser")}
            >
                {" "}
                Login as Seeker
            </span>
